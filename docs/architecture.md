...
workspace export, retention maintenance, backup/restore, and the database-backed
background-job queue remain platform services; no broker, cache, or
observability stack is bundled.
