...
| Data governance, portability, deletion, archive, restoration, and account retention | bootstrap, operational | 06 | conforming | [Data lifecycle](data-lifecycle.md), [export tests](../internal/portability/service_test.go), [account tests](../internal/identity/account_notification_test.go), [retention tests](../internal/platform/maintenance/maintenance_test.go) |
