...
func localizedLegacy(catalog *i18n.Catalog, locale i18n.Locale, value string) string {
	keys := map[string]string{
		...
		"Sessions": "sessions.sessions", "Security": "security.security", "Multi-factor authentication": "security.mfa_title", "Export": "navigation.export", "Import": "navigation.import",
