...
func TestBrowserPagesRenderSpanishDocuments(t *testing.T) {
	...
	paths := []string{
		...
		"/workspaces/" + workspaceID + "/settings/export", "/workspaces/" + workspaceID + "/settings/import", "/settings/language", "/sessions", "/security",
	}
...
func TestWebNavigationAndActionFeedback(t *testing.T) {
	...
	for _, page := range []string{workspaceRoot + "/settings/members", workspaceRoot + "/settings/invitations", workspaceRoot + "/settings/tokens", workspaceRoot + "/settings/export", workspaceRoot + "/settings/import"} {
...
func TestWebBaselineManagementRoutes(t *testing.T) {
	...
	for _, target := range []string{
		...
		"/sessions", "/security", "/workspaces/" + workspaceID + "/settings/export", "/workspaces/" + workspaceID + "/settings/import",
	} {
		response := request(handler, http.MethodGet, target, nil, cookies, nil)
		if response.Code != http.StatusOK {
